...
export default function ReminderButton({ bookingId }: { bookingId: string }) {
  ...
  return (
    <button 
      onClick={handleSend}
      disabled={loading}
      className="px-4 py-2 bg-[#25D366] hover:bg-[#20bd5c] text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all active:scale-95 flex items-center gap-2 disabled:opacity-50"
    >
